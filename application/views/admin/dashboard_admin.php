    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#ubahmodal<?php echo $i['id_admin']; ?>">
                                                        <i class="fa fa-edit"></i>Ubah
                                                    </button>
                                                    <p>&nbsp;</p>
                                                    <a href="<?php echo base_url() ?>admin/hapus_admin/<?php echo $i['id_admin']; ?>" class="btn btn-danger" onclick="return confirm('Hapus data?')">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo form_open_multipart('admin/tambah_admin/simpan'); ?>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" href="<?= site_url('admin') ?>">Simpan</button>
                            <?php echo form_close() ?>
                        </div>
                    </div>
                </div>
            ...
            foreach ($data->result_array() as $i) : $no++; ?>
                <div class="modal fade" id="ubahmodal<?php echo $i['id_admin']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Form Tambah Data</h5>
                            ...
                            <div class="modal-body">
                                <?php echo form_open_multipart('admin/proses_ubah_admin'); ?>
                                <input type="hidden" name="id_admin" id="id_admin" value="<?php echo $i['id_admin']; ?>">
                                <div class="form-group">
                                    <label>Username</label>
