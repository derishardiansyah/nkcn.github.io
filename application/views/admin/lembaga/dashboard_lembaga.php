    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#ubahmodal<?php echo $i['id_deskripsi']; ?>">
                                                        <i class="fa fa-edit"></i>Ubah
                                                    </button>
                                                    <p>&nbsp;</p>
                                                    <a href="<?php echo base_url() ?>admin_lembaga/hapus_lembaga/<?php echo $i['id_deskripsi']; ?>" class="btn btn-danger" onclick="return confirm('Hapus data?')">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo form_open_multipart('admin_lembaga/tambah_lembaga/simpan'); ?>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" href="<?= site_url('admin_lembaga') ?>">Simpan</button>
                            <?php echo form_close() ?>
                        </div>
                    </div>
                </div>
            ...
            foreach ($data->result_array() as $i) : $no++; ?>
                <div class="modal fade" id="ubahmodal<?php echo $i['id_deskripsi']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <?php echo form_open_multipart('admin_lembaga/proses_ubah_lembaga'); ?>
                                <input type="hidden" name="id_deskripsi" id="id_deskripsi" value="<?php echo $i['id_deskripsi']; ?>">
                                <div class="form-group">
                                    <label>Nama Lembaga</label>
                                ...
                                <div class="form-group">
                                    <label>Deskripsi</label>
                                    <input type="text" name="deskripsi" class="form-control" id="deskripsi" value="<?php echo $i['deskripsi']; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Kontak</label>
